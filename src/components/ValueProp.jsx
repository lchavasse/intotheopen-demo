    ...
    <section style={{ background: '#FFFDF7', borderBottom: '3px solid #1A1A1A', padding: '80px 0' }}>
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 32px' }}>
        <div style={{ maxWidth: 760, margin: '0 auto', textAlign: 'center' }}>
          ...
          <h2 style={{ fontSize: 'clamp(2rem, 4vw, 3.2rem)', fontWeight: 700, marginBottom: 24, lineHeight: 1.05, marginTop: 16 }}>
            Stop guessing.<br />Start knowing what works.
          </h2>
          <p style={{ fontSize: '1.1rem', lineHeight: 1.65, marginBottom: 48, opacity: 0.65, maxWidth: 620, margin: '0 auto 48px' }}>
          ...
          <div className="nb-card" style={{ background: '#A8D5F0', padding: '28px 36px', display: 'inline-block' }}>
