...
const COLORS = ['#FFE566', '#6BB5FF', '#FF6B9D', '#7BEA7B', '#C4A1FF', '#FF9A56', '#FFE566', '#6BB5FF', '#FF6B9D', '#7BEA7B']
    ...
    <section id="faq" style={{ background: '#FFFDF7', borderBottom: '3px solid #1A1A1A', padding: '80px 0' }}>
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 32px' }}>
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          ...
          <p style={{ fontSize: '1rem', opacity: 0.75, marginTop: 12 }}>Everything you need to know about intotheopen</p>
        </div>
          ...
          {faqs.map((faq, i) => (
            <div
              ...
              style={{
                ...
                borderRadius: 8,
                background: open === i ? COLORS[i] : '#FFFDF7',
            ...
            >
              <button
                ...
                style={{
                  ...
                  fontFamily: 'inherit', fontWeight: 700, fontSize: '0.95rem', textAlign: 'left', color: '#1A1A1A',
                }}
              >
                {faq.q}
                <span style={{ fontSize: '1.2rem', fontWeight: 700, marginLeft: 12, flexShrink: 0 }}>
                  {open === i ? '−' : '+'}
                </span>
              </button>
              {open === i && (
                <div style={{ padding: '0 24px 20px', fontSize: '0.9rem', lineHeight: 1.65, opacity: 0.85 }}>
                  {faq.a}
                </div>
              )}
            </div>
