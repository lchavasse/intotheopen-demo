export default function ProblemStatement() {
  return (
    <section style={{ background: '#A8D5F0', borderBottom: '3px solid #1A1A1A', padding: '80px 0' }}>
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 32px' }}>
        <div style={{ maxWidth: 680, margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '1.05rem', marginBottom: 28, opacity: 0.75 }}>
            Teams invest time, budget, and creativity into content without knowing:
          </p>
          <div className="nb-card" style={{ background: '#FFFDF7', padding: 32, marginBottom: 32, textAlign: 'left', width: '100%' }}>
          ...
          <p style={{ fontSize: '1.05rem', opacity: 0.75, marginBottom: 40 }}>
            By the time performance data arrives, the budget is already spent.
          </p>
          <div className="nb-card" style={{ background: '#FFE566', padding: '24px 32px', display: 'inline-block', transform: 'rotate(-1deg)' }}>
